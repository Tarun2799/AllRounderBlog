...
export const signup = async (req, res) => {
    ...
    // we don't have to use await here because hashSync already have the await by itself.
    ...
    // we are going to use try/catch for proper error handling because without this if we get any error it will display internal not to the client as response.
